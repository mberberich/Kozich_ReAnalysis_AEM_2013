...
```
This is our effort to reporuce the work of Kozich et al., which reanalyzed mouse data from Schloss et al. [@Schloss2012].
...
the 454 GS-FLX Titanium platform [@Yue2005]. In that study, we observed a clear separation
...
pairs of indices to resequence our mock community. We generated `r million_sequence_counts`
 million pairs of
